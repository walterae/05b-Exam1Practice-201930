...
def run_test_problem3a():
    ...
    point = rg.Point(140, 20)
    expected = 16
    answer = problem3a(window4, point, 4)
    print()
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6 (it is on window 4):
    point = rg.Point(240, 130)
    expected = 62
    answer = problem3a(window4, point, 8)
    print()
...
def problem3b(m, point1):
    ...
    count = 0
    for _ in range(m):
        val = problem3a(window, point1, lines)
        count = count + val
